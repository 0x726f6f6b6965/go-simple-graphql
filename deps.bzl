...
def go_dependencies():
    go_repository(
        ...
        sum = "h1:/l8JcEVQ93wqIfmH9VS1jsAkwm6eAF1NwQn3N+SDqBY=",
        version = "v0.17.40",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:dGebOupKwssrODV51E0zbMrv5e2gO9VWSLNC1WDCpWg=",
        version = "v4.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kQcaiGbJaIsRqgQy7VGlZrVw1giWO+lDoX3MCPnpVO4=",
        version = "v1.1.0",
    )
    go_repository(
        name = "com_github_steinfletcher_apitest",
        importpath = "github.com/steinfletcher/apitest",
        sum = "h1:AAdTN0yMbf0VMH/PMt9uB2I7jljepO6i+5uhm1PjH3c=",
        version = "v1.5.15",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:6zSM4azXC9u4Nxy5YmdmGu4uKamfwsdKTwp5zsEealU=",
        version = "v2.5.10",
    )
    go_repository(
